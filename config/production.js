...
module.exports = {
  ...
  passport: {
    /*
        ...
        2. top - right: register application
        3. create application for local dev and production
     */
    github: {
      clientID: "CLIENTID",
    ...
    // Change to your development machine hostname or leave as localhost
    persona: {
      audience: 'http://localhost:1337'
    },

    /*
            1. https://developers.google.com/+/web/signin/server-side-flow
            2. top - right: register application
            3. create application for local dev and production
         */
    googlePlus: {
